...
import 'package:mvc_template/src/app/examples/shrine/src/view.dart' show App, LoginPage;

import 'package:mvc_template/src/app/examples/shrine/src/model.dart' show I10n;
...
class _BackdropState extends State<Backdrop>
  ...
  PopupMenuButton<String> returnApp() {
    return PopupMenuButton<String>(
      onSelected: (String value) {
        I10n.load(Locale(value));
        Prefs.setString('locale', value);
